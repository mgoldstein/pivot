        ...
        plugin.method = {
            ...
            startQuiz: function(startButton) {
                $(startButton).fadeOut(300, function(){
					...
					var questionText = $('#' + selector + ' .questions li:eq(0) div.questionText p').text();
					questionText = questionText.substring(0,100);
					var message = '{"index":"0", "message": "'+questionText+'"}';
					doCallback ('quiz start', '{}');
            ...
            checkAnswer: function(checkButton) {
                var questionLI   = $($(checkButton).parents('li.question')[0]),
					questionText = questionLI.find('div.questionText p').text().substring(0,100),
            ...
            nextQuestion: function(nextButton) {
                ...
                if (nextQuestion.length) {
                    currentQuestion.fadeOut(300, function(){
						...
						questionText = nextQuestion.find('div.questionText p').text().substring(0,100);

					...
					<div class="social-share">
						...
						<ul>
							...
							<li>
						 	...
						 	<li>
								<a href="mailto:?subject=<?php echo $quizData->share->email->subject; ?>&amp;body=<?php echo $quizData->share->email->body; ?> <?php echo url('dml', array('absolute' => TRUE)).$quizData->share->email->link; ?>." target="_blank" class="email"></a>
							</li>
						</ul>

...
<div class="row two-column main">
    ...
    <div class="right">
        <div class="row video">
            <div id="video-one">
                <script type="text/javascript" src="http://video.takepart.com/players/<?php echo $homeData->videos->video_one->video_code; ?>-GzoxsJLK.js"></script>
            </div>
        </div>
        <div class="row cta">
            <div class="left">
            ...
            <div class="right">
                <a href="http://takeaction.takepart.com/actions?browse=pivot&cmpid=pivot-on-air&tags=We+Are+Legion&filtered=true&sort=recent"><img src="/<?php print drupal_get_path('module', 'pivot_dml'); ?>/images/WeAreLegion_180x235.jpg" style="float:right; height:100%;"></a>
